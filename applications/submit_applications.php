      ...
      <div id="main-body">
        ...
        <span id=appspan>Application Type:</span><select>
          ...
          <option value="attendence">UNDERTAKING FOR SHORT ATTENDENCE </option>
           <option value="extra">10% Extra ATTENDENCE </option>
        </select>
        ...
        <div id="extra" class="attendence options">
        <form method="POST" action="/ncw/scripts/10%cap.php">
            <span class="lop">Event <input type="text" class="leave-option" name="attend" autocomplete="off"></span>
